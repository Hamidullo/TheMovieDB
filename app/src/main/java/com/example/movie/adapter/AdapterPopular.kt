...
class AdapterPopular(private val movies: List<Result?>?, private val context: Context): RecyclerView.Adapter<AdapterPopular.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: AdapterPopular.ViewHolder, position: Int) {
